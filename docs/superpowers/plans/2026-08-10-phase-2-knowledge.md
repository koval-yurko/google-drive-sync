...
- [ ] **Step 3: Append the Phase 2 tables to the schema**
...
- [ ] **Step 5: Confirm the action is discovered**
...
- [ ] **Step 3: Document the phase in the README**
